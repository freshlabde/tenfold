...
export default defineConfig({
  ...
  webServer: {
    ...
    // Nothing is seeded into it any more: until v1.1 a fixed sync id was copied
    // in to satisfy the model relay's caller gate, and both are gone.
    command: `rm -rf ${TEST_DATA} && mkdir -p ${TEST_DATA} && node tools/serve.js`,
